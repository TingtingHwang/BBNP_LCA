...
info = geotiffinfo(['./Dataset/Raw_data_30m/' Tiffname{1} '.tif']);  % è¯»å–tifæ•°æ®çš„åœ°ç†ä¿¡æ¯ï¼Œä¸ºåŽé¢å¯¼å‡ºä¸ºtifæ•°æ®æä¾›åœ°ç†ä¿¡æ¯
...
% Save data
%     mkdir('./results_DB/');
%     calculatedata=['./results_DB/', 'OPMC_SC_100m_1','.xls'];
%%  Ñ­»·¼ÆËã
for tt=22:30
...
%     
    ...
    savenametif=['./results_tif/','OPMC_30m_med33_',num2str(Ncluster),'.tif'];
